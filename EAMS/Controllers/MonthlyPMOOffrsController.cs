...
{
    public class MonthlyPMOOffrsController : Controller
    {
        // GET: MonthlyPMOOffrs
        ...
        //private ActionResult GetReportData()
        //{
        ...
        private void GetMonthlyPMOData(UnitWork1 unitOfWork, IEnumerable<SponsorData> sponsrdata, IEnumerable<ESMOfficersDetail> esmData, IEnumerable<CompanyMaster> companyData)
        {
            ...
            var MonPmoDt = new MothlyPMODataVM()
            {
